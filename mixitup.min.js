        ...
        parseStatusChange: function(t, e, n, a) {
            ...
            switch (i.callActions("beforeParseStatusChange", arguments), i.type) {
                ...
                case "sort":
                    ...
                    break;
                case "toggle":
                    for (a.length < 1 && i.renderStatus(t, "inactive"), e.filter === n.filter && i.renderStatus(t, "active"), s = 0; s < a.length; s++) { if (r = a[s], r === n.filter) { i.renderStatus(t, "active"); break } i.renderStatus(t, "inactive") }
            }
